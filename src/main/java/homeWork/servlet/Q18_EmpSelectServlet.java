...
public class Q18_EmpSelectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASS);
            ...
            String createTable = "CREATE TABLE IF NOT EXISTS employee_info ("
            ...
            stmt.executeUpdate("DELETE FROM employee_info");
            stmt.executeUpdate("INSERT INTO employee_info VALUES (101, 'Rajesh Kumar', '12 MG Road, Delhi', '9876543210')");
            stmt.executeUpdate("INSERT INTO employee_info VALUES (102, 'Sunita Sharma', '45 Park Street, Kolkata', '9123456789')");
            stmt.executeUpdate("INSERT INTO employee_info VALUES (103, 'Vikash Singh', '78 Anna Salai, Chennai', '9988776655')");
            stmt.executeUpdate("INSERT INTO employee_info VALUES (104, 'Meena Devi', '23 Banjara Hills, Hyderabad', '9871234567')");
            ...
            out.println("<tr style='background-color:#1976D2; color:white;'>");
